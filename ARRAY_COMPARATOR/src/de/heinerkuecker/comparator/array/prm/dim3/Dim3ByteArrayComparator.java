 ...
 */
public class Dim3ByteArrayComparator
extends ComparatorArrayComparator<byte[][]>
{
     ...
     */
    public Dim3ByteArrayComparator(
    ...
    public String toString()
    {
        return
                ...
                "subSubArrayNulls=" + ( (Dim2ByteArrayComparator) this.comparator ).elementNulls +
                "]";
    }
