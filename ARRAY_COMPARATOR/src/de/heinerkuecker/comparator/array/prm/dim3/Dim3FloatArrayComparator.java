 ...
 */
public class Dim3FloatArrayComparator
extends ComparatorArrayComparator<float[][]>
{
     ...
     */
    public Dim3FloatArrayComparator(
    ...
    public String toString()
    {
        return
                ...
                "subSubArrayNulls=" + ( (Dim2FloatArrayComparator) this.comparator ).elementNulls +
                "]";
    }
